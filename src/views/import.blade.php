                  ...
                  <?php 
                    ...
                    function checkFormColumns($column)
                    {
                      switch($column)
                      {
                        ...
                        case 'homeno' : $field = 'Home Number'; break;
                        case 'officeno' : $field = 'Office Number'; break;
                        ...
                        case 'sex' : $field = 'Sex'; break;
                        case 'age_group' : $field = 'Age Group'; break;
                        case 'from_brand': $field = 'From Brand'; break;
                        case 'to_brand' : $field = 'To Brand'; break;
                        case 'relationship' : $field = 'Relationship'; break;
                        case 'current_age' : $field = 'Current Age'; break;
                        case 'race' : $field = 'Race'; break;
                        case 'stopped_milk_date' : $field = 'Stopped Milk Date'; break;
                        case 'follow_up_date' : $field = 'Follow Up Date'; break;
                        case 'customer_wyeth_id' : $field = 'Wyeth Customer ID'; break;
                        case 'sample_distributed' : $field = 'Sample Distributed'; break;
                        case 'sample_distribution_remarks' : $field = 'Sample Distributed Remarks'; break;
                        case 'sample_received' : $field = 'Sample Received'; break;
                        case 'sample_tried' : $field = 'Sample Tried'; break;
                        case 'sample_trial_reason' : $field = 'Sample Tried Reason'; break;
