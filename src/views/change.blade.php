  ...
  <body class="login-page">
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form autocomplete='off' action="{{ route('postChangePassword') }}" method="post">
          ...
          <div style="margin-bottom:10px" class='row'>
            <div class='col-xs-12'>
                <button type="submit" class="btn btn-primary btn-block btn-flat"><i class='fa fa-lock'></i> Reset Password </button>
            </div>
          </div>       
        </form>
    <br/>
